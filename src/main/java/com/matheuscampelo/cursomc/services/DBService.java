...
public void instatiateDatabase() throws ParseException {
	...
	Produto p7 = new Produto (null,"TV",860.00);
	Produto p8 = new Produto (null,"Roçadeira",530.00);
	Produto p9 = new Produto (null,"Abajour",230.00);
	Produto p10 = new Produto (null,"Pendente",10.00);
	Produto p11 = new Produto (null,"Shampoo",120.00);
